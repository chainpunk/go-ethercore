...
func TestConsoleWelcome(t *testing.T) {
	...
	geth.SetTemplateFunc("niltime", func() string { return time.Unix(1577836800, 0).Format(time.RFC1123) })
...
func testAttachWelcome(t *testing.T, geth *testgeth, endpoint, apis string) {
	...
	attach.SetTemplateFunc("niltime", func() string { return time.Unix(1577836800, 0).Format(time.RFC1123) })
