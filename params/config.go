...
var (
	...
	EtherCoreTestGenesisHash = common.HexToHash("0x882bef94a19a1ea0dce9cb602fec35f82164535e641e4898ddc8a0ab6ecbd2f5")
)
...
var (
	...
	EtherCoreTestChainConfig = &ChainConfig{
		...
		DAOForkSupport:      true,
		EIP150Block:         big.NewInt(0),
		EIP150Hash:          common.HexToHash("0x882bef94a19a1ea0dce9cb602fec35f82164535e641e4898ddc8a0ab6ecbd2f5"),
		EIP155Block:         big.NewInt(0),
		EIP158Block:         big.NewInt(0),
		ByzantiumBlock:      big.NewInt(0),
		ConstantinopleBlock: big.NewInt(0),
